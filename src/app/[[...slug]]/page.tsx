      ...
      <div>
        ...
        {tab === "weekend" && (
          <div>
            ...
            <br />
            <p>Although our <a onClick={() => setTab("wedding")}>wedding day</a> will be adults only, <span className="underline">kids are very much welcome to both the Friday and Saturday events!</span></p>
            <br /><hr />
