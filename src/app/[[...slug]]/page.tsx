        ...
        <div>
          {tab === "home" && (
            <div>
              ...
              <br />
              <p>In the tabs above, you&apos;ll find all the information you need about <a onClick={() => setTab("wedding")}>our big day</a>, some <a onClick={() => setTab("weekend")}>optional events on the Friday and Saturday</a>, and the <a onClick={() => setTab("directions")}>directions and accommodation recommendations</a>.</p>
              <br />
          ...
          {tab === "wedding" && (
            <div>
              ...
              <div className="order">
                ...
                <p>Family style dinner: veggie dogs, potato salad, green salad, corn.</p>
                <br />
